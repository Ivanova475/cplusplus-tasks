...
{
    //вызывает snake.GetBody apple.GetPosition и для всех стен формирует рандомную клетку которая не лежит в теле змеи и не лежит в яблоке и проверяем что полученная клетка не принадлежит ни одной из стен 
} */